...
public class OperativaImplementacion implements OperativaInterfaz {
	 ...
	 * acarrez
	 * @param letra - parámetro que contiene la letra del DNI introducida por el usuario
	 * @param numero - parámetro que contiene el número del DNI introducido por el usuario
	 * 03/03/2025
	 */
